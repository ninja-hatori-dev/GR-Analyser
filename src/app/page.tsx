    ...
    <div className="flex min-h-screen flex-col bg-neutral-950">
      ...
      <header className="sticky top-0 z-50 flex w-full items-center justify-between border-b border-slate-800/50 bg-zinc-900/80 px-6 py-5 md:px-10">
        <Link href="/" className="flex items-center justify-center gap-2">
          <img src="/logo.png" alt="GR Analyser Logo" width={40} height={40} />
      ...
      <main className="flex flex-col gap-16">
        ...
        <section className="mx-auto mt-32 flex max-w-[80vw] flex-col items-center gap-8">
          <Image src="/logo.png" alt="GR Analyser Logo" width={100} height={100} />
          <div className="mb-10 text-center">
            ...
            <p className="mb-8 text-xl text-gray-300">
              GR Analyser helps you quickly comprehend your codebase, find relevant
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <Button
                ...
                asChild
              >
                <Link href="https://github.com/ninja-hatori-dev" target="_blank">
        ...
        <section className="flex flex-col items-center px-6 py-20 md:px-10">
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-8 text-xl text-gray-300">
              Join GR Analyser today and experience the power of AI-assisted code
              understanding.
            </p>
      ...
      <footer className="border-t border-white/10 px-6 py-6 text-center md:px-10">
        <p className="text-sm text-white/70">
          ...
          <Link
            ...
            target="_blank"
            href="https://github.com/ninja-hatori-dev"
          >
           Anshul
          </Link>
        </p>
